...
@endif
@php
    $url = ($config['method'] == 'create') ? route('homestay.store') : route('homestay.update', $homestay->id);
@endphp
<form action="{{ $url }}" method="post" class="box">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-9">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        @include('backend.homestay.component.content', ['model' => ($homestay) ?? null])
                    </div>
                </div>
                <div class="ibox">
                    <div class="ibox-title">
                    ...
                    <div class="ibox-content">
                        @php
                            $album = (isset($homestay->album) && is_array($homestay->album)) ? $homestay->album : ( (!empty($homestay->album)) ? json_decode($homestay->album) : [] );
            ...
            <div class="col-lg-3">
                @include('backend.homestay.component.aside',['post' => ($homestay) ?? null])
            </div>
        </div>
