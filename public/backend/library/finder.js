(function($) {
    ...
    HT.checkBox = () => {
        $(document).on('click', '.wizard-form-checkbox .color', function() {
            ...
            let checkBox = $('input[name="color_id"][id="' + labelFor + '"]');
            ...
            if(_this.hasClass('active')){
                ...
                $('input[name="color_id"]').prop('checked', false);
